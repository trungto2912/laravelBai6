            ...
            <div class="table-responsive">
                ...
                @foreach($all_brand_product as $key => $brand_pro)
                    <tr>
                        ...
                        <td>{{ $brand_pro->Bslug }}</td>
                        <td><span class="text-ellipsis">

                            <?php
                            if($brand_pro->Bstatus==1){
                            ?>
                                <a href="{{URL::to('/unactive-brand-product/'.$brand_pro->Bid)}}"><span class="fa-thumb-styling fa fa-thumbs-up"></span></a>
                            <?php
                            }else{
                            ?> 
                                <a href="{{URL::to('/active-brand-product/'.$brand_pro->Bid)}}"><span class="fa-thumb-styling fa fa-thumbs-down"></span></a>
                            <?php
                            }
                            ?>
                        </span></td>
